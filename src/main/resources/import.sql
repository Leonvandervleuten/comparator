...
-- insert into search_elements(element, csv_file_id) values(061234567823432432, 1)
-- insert into search_elements(element, csv_file_id) values('+_)(*^%#@@%&*((*&%$#{}{:>>})', 1)
...
-- insert into search_elements(element, csv_file_id) values(12344, 1)
--
-- insert into search_elements(element, csv_file_id) values(0612345678, 2)
-- insert into search_elements(element, csv_file_id) values(061234567823432432, 2)
-- insert into search_elements(element, csv_file_id) values('+_)(*^%#@@%&*((*&%$#{}{:>>})', 2)
-- insert into search_elements(element, csv_file_id) values('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer dictum nunc quis dolor imperdiet luctus. Suspendisse vehicula, turpis eget rutrum sollicitudin, erat nibh molestie mi, in pretium nisl felis ut justo. Proin maximus ullamcorper tempus turpis.', 2)
-- insert into search_elements(element, csv_file_id) values(12344, 2)
--
-- insert into search_elements(element, csv_file_id) values(0612345678, 3)
-- insert into search_elements(element, csv_file_id) values(061234567823432432, 3)
-- insert into search_elements(element, csv_file_id) values('+_)(*^%#@@%&*((*&%$#{}{:>>})', 3)
-- insert into search_elements(element, csv_file_id) values('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer dictum nunc quis dolor imperdiet luctus. Suspendisse vehicula, turpis eget rutrum sollicitudin, erat nibh molestie mi, in pretium nisl felis ut justo. Proin maximus ullamcorper tempus turpis.', 3)
-- insert into search_elements(element, csv_file_id) values(12344, 3)